...
class contactsAdapters (private var context: Context, var items:ArrayList<Contact>): BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        viewHolder.floatingButton.setOnClickListener {
            ...
            val intent = Intent(context, MapActivity::class.java).also {


                //it.putExtra("latitudedata", strlat)
                //it.putExtra("longidata", strlong)
                //it.putExtra("passname", strname)
            }
