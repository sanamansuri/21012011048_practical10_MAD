...
class activity_contact_details(private var context: Context, var items:ArrayList<Contact>): BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        viewHolder.floatingButton.setOnClickListener {
            ...
            intent.putExtra("latitudedata", strlat)
            intent.putExtra("longidata", strlong)
            intent.putExtra("passname", strname)
